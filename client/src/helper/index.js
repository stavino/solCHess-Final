const diagonalDictionaryTLBR = require('../dictionary/diagonalTopLeftBottomRight.json');
const diagonalDictionaryTRBL = require('../dictionary/diagonalTopRightBottomLeft.json');
const rowDictionary = require('../dictionary/row.json');
const columnDictionary = require('../dictionary/column.json');
