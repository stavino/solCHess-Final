...
exports.SolflareWebWalletAdapter = exports.SolflareWebWalletName = exports.SolletExtensionWalletAdapter = exports.SolletExtensionWalletName = exports.SolletWalletAdapter = exports.SolletWalletName = void 0;
const base_1 = require("./base");
exports.SolletWalletName = 'Sollet';
class SolletWalletAdapter extends base_1.BaseSolletWalletAdapter {
    constructor(_a = {}) {
        var { provider = 'https://www.sollet.io' } = _a, config = __rest(_a, ["provider"]);
        super(Object.assign({ provider }, config));
        this.name = exports.SolletWalletName;
...
exports.SolletExtensionWalletName = 'Sollet (Extension)';
class SolletExtensionWalletAdapter extends base_1.BaseSolletWalletAdapter {
    constructor() {
        super(...arguments);
        this.name = exports.SolletExtensionWalletName;
...
exports.SolflareWebWalletName = 'Solflare (Web)';
class SolflareWebWalletAdapter extends base_1.BaseSolletWalletAdapter {
    constructor(_a = {}) {
        var { provider = 'https://solflare.com/access-wallet' } = _a, config = __rest(_a, ["provider"]);
        super(Object.assign({ provider }, config));
        this.name = exports.SolflareWebWalletName;
...
exports.SolflareWebWalletAdapter = SolflareWebWalletAdapter;
